...
A file picker will open — select your lung-cancer.data file.
Outputs: lung_cancer_results.png saved to same folder as the data file.
"""
...
out = os.path.join(OUT_DIR, 'lung_cancer_results.png')
