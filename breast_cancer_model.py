...
Outputs: breast_cancer_results.png, prints metrics to console.
Place breast-cancer.data in the same directory.
"""
...
# ── CONFIG ───────────────────────────────────────────────────────────────────
DATA_PATH    = 'breast-cancer.data'   # update path if needed
TEST_SIZE    = 0.20
N_TREES      = 300
RANDOM_STATE = 42
