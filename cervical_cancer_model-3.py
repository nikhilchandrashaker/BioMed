...
A file picker will open — select your risk_factors_cervical_cancer.csv file.
Outputs: cervical_cancer_results.png saved to same folder as the data file.
"""
...
DATA_PATH = filedialog.askopenfilename(
    title="Select risk_factors_cervical_cancer.csv",
...
out = os.path.join(OUT_DIR, 'cervical_cancer_results.png')
